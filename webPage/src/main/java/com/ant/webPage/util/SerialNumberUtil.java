...
public class SerialNumberUtil {
     ...
     * @return 随机码
     */
    public static String toSerialNumber(Integer num) {
    ...
    public static void main(String[] args){
        for(int i = 1; i<1000000;i++){
            System.out.println(toSerialNumber(i));
        }
        /*for(int i=1;i<10000;i++){
            String invitationCode = RandomUtil.randomString(6);
            System.out.println(invitationCode);
        }
        for(int i=1;i<10000;i++){
            String invitationCode = RandomUtil.randomUUID();
            System.out.println(invitationCode);
        }*/
    }
}
